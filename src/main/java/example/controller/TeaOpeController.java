...
import example.service.NeedHomeworkService;
import example.service.StudentHomeworkService;
...
public class TeaOpeController {
   ...
   @Autowired
   public TeaOpeController(NeedHomeworkService needHomeworkService,StudentService studentService,StudentHomeworkService studentHomeworkService)
   {
       this.needHomeworkService=needHomeworkService;
